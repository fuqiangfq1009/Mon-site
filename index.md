...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
    ...
    #content-area h1 { color: #c00; font-size: 48px; margin-bottom: 25px; text-shadow: 1px 1px 2px rgba(0,0,0,0.2); }
    #content-area p { font-size: 20px; color: #444; margin-bottom: 30px; line-height: 1.8; }
    .btn { display: inline-block; background-color: #c00; color: white; padding: 14px 30px; border-radius: 6px; text-decoration: none; font-weight: bold; font-size: 18px; transition: background 0.3s, transform 0.2s; }
