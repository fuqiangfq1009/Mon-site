...
#content-area { background:#fff; border-radius:8px; padding:40px 30px; margin:30px 0; min-height:500px; box-shadow:0 4px 15px rgba(0,0,0,0.1); }
...
.btn { display:inline-block; background-color:#c00; color:white; padding:14px 30px; border-radius:6px; text-decoration:none; font-weight:bold; font-size:18px; transition: background 0.3s, transform 0.2s; margin-top:20px; }
.btn:hover { background-color:#a23; transform:translateY(-2px); }
footer { background-color:#333; color:white; text-align:center; padding:20px 0; margin-top:30px; }
@media(max-width:768px) { nav { flex-direction:column; height:auto; } .nav-links { margin-top:10px; flex-wrap:wrap; justify-content:center; } .nav-links li { margin:5px; } #content-area { padding:30px 20px; } #content-area h1 { font-size:32px; } #content-area h2 { font-size:28px; } #content-area h3 { font-size:24px; } #content-area p { font-size:16px; } .btn { font-size:16px; padding:12px 25px; } }
</style>
</head>
<body>
<header>
